...
* Mikrodenetleyici sistemleri / Microcontroller systems
* Donanım bakımı, arıza tespiti ve PC toplama / Hardware maintenance, troubleshooting, and PC building
* 2D / 3D oyun geliştirme / 2D / 3D game development

## 🛠️ Kullandığım Teknolojiler / Technologies
